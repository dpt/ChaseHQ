...
#define CONTINUE_MESSAGES_CREDIT_N  (0x8D8C - CONTINUE_MESSAGES_BASE)
  ...
  // trackers and self-modifying scratch bytes, plus title-screen animation
  // and options-menu state. Opaque pointer: the fields live in
  // struct chq_bank3_state (Bank3State.h), which only Bank3.c includes, so
