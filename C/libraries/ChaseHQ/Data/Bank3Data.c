...
/** $F8F2: sfx_sample_1_template (104 bytes, played back with D=$68 rows) */
const u8 sfx_sample_1_template[104] = {
...
/** $F95A: sfx_sample_2_template (224 bytes, played back with D=$E0 rows) */
const u8 sfx_sample_2_template[224] = {
