...
static const pixel_t stage5_bitmap_C960[6 * 1 * 30 * 1];
static const pixel_t stage5_bitmap_CA14[5 * 1 * 22 * 1];
static const pixel_t stage5_bitmap_CA82[3 * 1 * 15 * 1];
static const pixel_t stage5_bitmap_CAAF[3 * 2 * 8 * 1];
static const pixel_t stage5_bitmap_CADF[3 * 2 * 8 * 1];
static const pixel_t stage5_bitmap_CB0F[6 * 1 * 39 * 1];
static const pixel_t stage5_bitmap_CBF9[5 * 1 * 29 * 1];
static const pixel_t stage5_bitmap_CC8A[3 * 1 * 20 * 1];
static const pixel_t stage5_bitmap_CCC6[2 * 2 * 12 * 1];
static const pixel_t stage5_bitmap_CCF6[2 * 2 * 12 * 1];
static const pixel_t stage5_bitmap_CD26[6 * 1 * 30 * 1];
static const pixel_t stage5_bitmap_CDDA[4 * 1 * 20 * 1];
static const pixel_t stage5_bitmap_CE2A[3 * 1 * 13 * 1];
static const pixel_t stage5_bitmap_CE51[2 * 2 * 8 * 1];
static const pixel_t stage5_bitmap_CE71[2 * 2 * 8 * 1];
static const pixel_t stage5_bitmap_D073[5 * 1 * 8 * 1];
static const pixel_t stage5_bitmap_D09B[7 * 1 * 8 * 1];
static const pixel_t stage5_bitmap_D0D3[7 * 1 * 8 * 1];
static const pixel_t stage5_bitmap_D10B[8 * 1 * 8 * 1];
static const pixel_t stage5_bitmap_D14B[3 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D157[4 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D16C[5 * 1 * 6 * 1];
static const pixel_t stage5_bitmap_D18A[6 * 1 * 6 * 1];
static const pixel_t stage5_bitmap_D1AE[2 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D1B6[3 * 1 * 3 * 1];
static const pixel_t stage5_bitmap_D1BF[3 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D1CB[4 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D1DB[1 * 1 * 3 * 1];
static const pixel_t stage5_bitmap_D1DE[2 * 1 * 3 * 1];
static const pixel_t stage5_bitmap_D1E4[2 * 1 * 3 * 1];
static const pixel_t stage5_bitmap_D1EA[3 * 1 * 2 * 1];
static const pixel_t stage5_bitmap_D1F0[7 * 1 * 8 * 1];
static const pixel_t stage5_bitmap_D228[5 * 1 * 6 * 1];
static const pixel_t stage5_bitmap_D246[3 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D252[2 * 1 * 3 * 1];
static const pixel_t stage5_bitmap_D258[1 * 2 * 1 * 1];
static const pixel_t stage5_bitmap_D25A[2 * 2 * 1 * 1];
static const pixel_t stage5_bitmap_D25E[2 * 2 * 2 * 1];
static const pixel_t stage5_bitmap_D266[3 * 2 * 2 * 1];
static const pixel_t stage5_bitmap_D272[1 * 2 * 1 * 1];
static const pixel_t stage5_bitmap_D274[2 * 2 * 1 * 1];
static const pixel_t stage5_bitmap_D278[2 * 2 * 2 * 1];
static const pixel_t stage5_bitmap_D280[3 * 2 * 2 * 1];
static const pixel_t stage5_bitmap_D380[4 * 1 * 16 * 1];
static const pixel_t stage5_bitmap_D3C0[4 * 1 * 24 * 1];
static const pixel_t stage5_bitmap_D420[24];
static const pixel_t stage5_bitmap_D438[4 * 1 * 16 * 1];
static const pixel_t stage5_bitmap_D478[4 * 1 * 24 * 1];
static const pixel_t stage5_bitmap_D4D8[3 * 1 * 12 * 1];
static const pixel_t stage5_bitmap_D4FC[3 * 1 * 18 * 1];
static const pixel_t stage5_bitmap_D535[18];
static const pixel_t stage5_bitmap_D547[3 * 1 * 12 * 1];
static const pixel_t stage5_bitmap_D56B[3 * 1 * 18 * 1];
static const pixel_t stage5_bitmap_D5A1[2 * 1 * 8 * 1];
static const pixel_t stage5_bitmap_D5B1[2 * 1 * 12 * 1];
static const pixel_t stage5_bitmap_D5C9[12];
static const pixel_t stage5_bitmap_D5D5[2 * 1 * 8 * 1];
static const pixel_t stage5_bitmap_D5E5[2 * 1 * 12 * 1];
static const pixel_t stage5_bitmap_D5FD[1 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D601[1 * 1 * 6 * 1];
static const pixel_t stage5_bitmap_D607[7];
static const pixel_t stage5_bitmap_D60E[1 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D612[1 * 1 * 6 * 1];
static const pixel_t stage5_bitmap_D64A[4 * 1 * 17 * 1];
static const pixel_t stage5_bitmap_D68E[3 * 1 * 13 * 1];
static const pixel_t stage5_bitmap_D6B5[2 * 1 * 9 * 1];
static const pixel_t stage5_bitmap_D6C7[2 * 2 * 7 * 1];
static const pixel_t stage5_bitmap_D6E3[2 * 2 * 7 * 1];
...
static const pixel_t stage5_bitmap_D8C2[1 * 2 * 2 * 1];
static const pixel_t stage5_bitmap_D8C6[1 * 2 * 6 * 1];
static const pixel_t stage5_bitmap_D93B[5 * 1 * 8 * 1];
static const pixel_t stage5_bitmap_D963[4 * 1 * 6 * 1];
static const pixel_t stage5_bitmap_D97B[3 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D987[3 * 1 * 4 * 1];
static const pixel_t stage5_bitmap_D993[3 * 2 * 3 * 1];
static const pixel_t stage5_bitmap_D9A5[3 * 2 * 3 * 1];
static const pixel_t stage5_bitmap_D9B7[2 * 2 * 2 + 4];
static const pixel_t stage5_bitmap_D9C3[2 * 2 * 2 + 4];
static const pixel_t stage5_bitmap_DA32[3 * 1 * 13 * 1];
static const pixel_t stage5_bitmap_DA59[3 * 1 * 10 * 1];
static const pixel_t stage5_bitmap_DA77[3 * 1 * 7 * 1];
static const pixel_t stage5_bitmap_DA8C[3 * 1 * 7 * 1];
static const pixel_t stage5_bitmap_DAA1[2 * 2 * 5 * 1];
static const pixel_t stage5_bitmap_DAB5[2 * 2 * 5 * 1];
static const pixel_t stage5_bitmap_DAC9[2 * 2 * 4 * 1];
