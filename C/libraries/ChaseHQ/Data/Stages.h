...
/* Objects
 *
 * These object values are common across all stages.
 */
#define MAP_OBJ_NONE_VAL                (0)
#define MAP_OBJ_TUNNEL_LIGHT_VAL        (1)
#define MAP_OBJ_SHORT_POLE_VAL          (3)

#define MAP_OBJ_NONE(D)                 (((D) << 4) | MAP_OBJ_NONE_VAL)
#define MAP_OBJ_TUNNEL_LIGHT(D)         (((D) << 4) | MAP_OBJ_TUNNEL_LIGHT_VAL)
#define MAP_OBJ_SHORT_POLE(D)           (((D) << 4) | MAP_OBJ_SHORT_POLE_VAL)
