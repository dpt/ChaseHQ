...
/* Deduplicated graphics. */

extern const u8 perp_description[7];
...
extern const pixel_t bitmap_truck_4s[2 * 2 * 12 * 1];
extern const pixel_t bitmap_car_4[3 * 2 * 9 * 1];
extern const pixel_t bitmap_car_4s[3 * 2 * 9 * 1];
extern const pixel_t bitmap_stones_1[2 * 2 * 5 * 1];
extern const pixel_t bitmap_stones_2[2 * 2 * 4 * 1];
extern const pixel_t bitmap_stones_2s[2 * 2 * 4 * 1];
extern const pixel_t bitmap_stones_3[2 * 2 * 3 * 1];
extern const pixel_t bitmap_stones_3s[2 * 2 * 3 * 1];
extern const pixel_t bitmap_stones_4[1 * 2 * 2 * 1];
extern const pixel_t bitmap_stones_4s[1 * 2 * 2 * 1];
extern const pixel_t bitmap_stones_5[1 * 2 * 1 * 1];
extern const pixel_t bitmap_stones_5s[1 * 2 * 1 * 1];
extern const pixel_t bitmap_dust_1[1 * 2 * 1 * 1];
extern const pixel_t bitmap_dust_1s[1 * 2 * 1 * 1];
extern const pixel_t bitmap_turnsign_1[4 * 1 * 40 * 1];
extern const pixel_t bitmap_turnsign_2[3 * 1 * 30 * 1];
extern const pixel_t bitmap_turnsign_3[2 * 1 * 20 * 1];
extern const pixel_t bitmap_turnsign_4[2 * 2 * 16 * 1];
extern const pixel_t bitmap_turnsign_5[2 * 2 * 13 * 1];
extern const pixel_t bitmap_tumbleweed_1[2 * 1 * 16 * 1];
extern const pixel_t bitmap_tumbleweed_2[2 * 1 * 11 * 1];
extern const pixel_t bitmap_tumbleweed_3[1 * 1 * 9 * 1];
extern const pixel_t bitmap_tumbleweed_4[1 * 1 * 7 * 1];
extern const pixel_t bitmap_barrier_1[4 * 1 * 17 * 1];
extern const pixel_t bitmap_barrier_2[3 * 1 * 13 * 1];
extern const pixel_t bitmap_barrier_3[2 * 1 * 9 * 1];
extern const pixel_t bitmap_barrier_4[2 * 2 * 7 * 1];
extern const pixel_t bitmap_barrier_4s[2 * 2 * 7 * 1];
extern const pixel_t bitmap_streetlamptop_1[4 * 1 * 8 * 1];
extern const pixel_t bitmap_streetlamptop_2[3 * 1 * 5 * 1];
extern const pixel_t bitmap_streetlamptop_3[3 * 1 * 4 * 1];
extern const pixel_t bitmap_streetlamptop_3s[3 * 1 * 4 * 1];
extern const pixel_t bitmap_streetlamptop_4[2 * 2 * 4 * 1];
extern const pixel_t bitmap_streetlamptop_4s[2 * 2 * 4 * 1];
extern const pixel_t bitmap_streetlamptop_5[2 * 2 * 3 * 1];
extern const pixel_t bitmap_streetlamptop_5s[2 * 2 * 3 * 1];
extern const pixel_t bitmap_telegraphpoletop_1[3 * 1 * 13 * 1];
extern const pixel_t bitmap_telegraphpoletop_2[3 * 1 * 10 * 1];
extern const pixel_t bitmap_telegraphpoletop_3[3 * 1 * 7 * 1];
extern const pixel_t bitmap_telegraphpoletop_3s[3 * 1 * 7 * 1];
extern const pixel_t bitmap_telegraphpoletop_4[2 * 2 * 5 * 1];
extern const pixel_t bitmap_telegraphpoletop_4s[2 * 2 * 5 * 1];
extern const pixel_t bitmap_telegraphpoletop_5[2 * 2 * 4 * 1];
extern const pixel_t bitmap_telegraphpoletop_5s[2 * 2 * 4 * 1];
extern const pixel_t pilot_mugshot[180];
...
extern const pixel_t bitmap_F318[7 * 1 * 8 * 1];
extern const pixel_t bitmap_F350[7 * 1 * 8 * 1];
extern const pixel_t bitmap_F388[8 * 1 * 8 * 1];
extern const pixel_t bitmap_F3C8[3 * 1 * 4 * 1];
extern const pixel_t bitmap_F3D4[4 * 1 * 4 * 1];
extern const pixel_t bitmap_F3E9[5 * 1 * 6 * 1];
extern const pixel_t bitmap_F407[6 * 1 * 6 * 1];
extern const pixel_t bitmap_F42B[2 * 1 * 4 * 1];
extern const pixel_t bitmap_F433[3 * 1 * 3 * 1];
extern const pixel_t bitmap_F43C[3 * 1 * 4 * 1];
extern const pixel_t bitmap_F448[4 * 1 * 4 * 1];
extern const pixel_t bitmap_F458[1 * 1 * 3 * 1];
extern const pixel_t bitmap_F45B[2 * 1 * 3 * 1];
extern const pixel_t bitmap_F461[2 * 1 * 3 * 1];
extern const pixel_t bitmap_F467[3 * 1 * 2 * 1];
extern const pixel_t bitmap_F46D[7 * 1 * 8 * 1];
extern const pixel_t bitmap_F4A5[5 * 1 * 6 * 1];
extern const pixel_t bitmap_F4C3[3 * 1 * 4 * 1];
extern const pixel_t bitmap_F4CF[2 * 1 * 3 * 1];
extern const pixel_t bitmap_F4D5[1 * 2 * 1 * 1];
extern const pixel_t bitmap_F4D7[2 * 2 * 1 * 1];
extern const pixel_t bitmap_F4DB[2 * 2 * 2 * 1];
extern const pixel_t bitmap_F4E3[3 * 2 * 2 * 1];
extern const pixel_t bitmap_F4EF[1 * 2 * 1 * 1];
extern const pixel_t bitmap_F4F1[2 * 2 * 1 * 1];
extern const pixel_t bitmap_F4F5[2 * 2 * 2 * 1];
extern const pixel_t bitmap_F4FD[3 * 2 * 2 * 1];
extern const pixel_t bitmap_F8A2[1 * 2 * 2 * 1];
extern const pixel_t bitmap_F97B[5 * 1 * 8 * 1];
extern const pixel_t bitmap_F9A3[4 * 1 * 6 * 1];
extern const pixel_t bitmap_F9BB[3 * 1 * 4 * 1];
extern const pixel_t bitmap_F9C7[3 * 1 * 4 * 1];
extern const pixel_t bitmap_F9D3[3 * 2 * 3 * 1];
extern const pixel_t bitmap_F9E5[3 * 2 * 3 * 1];
...
extern const pixel_t bitmap_D3EF[4 * 1 * 24 * 1];
extern const pixel_t bitmap_D44F[24];
extern const pixel_t bitmap_D467[4 * 1 * 16 * 1];
extern const pixel_t bitmap_D4A7[4 * 1 * 24 * 1];
extern const pixel_t bitmap_D507[3 * 1 * 12 * 1];
extern const pixel_t bitmap_D52B[3 * 1 * 18 * 1];
extern const pixel_t bitmap_D564[18];
extern const pixel_t bitmap_D576[3 * 1 * 12 * 1];
extern const pixel_t bitmap_D59A[3 * 1 * 18 * 1];
extern const pixel_t bitmap_D5D0[2 * 1 * 8 * 1];
extern const pixel_t bitmap_D5E0[2 * 1 * 12 * 1];
extern const pixel_t bitmap_D5F8[12];
extern const pixel_t bitmap_D604[2 * 1 * 8 * 1];
extern const pixel_t bitmap_D614[2 * 1 * 12 * 1];
extern const pixel_t bitmap_D62C[1 * 1 * 4 * 1];
extern const pixel_t bitmap_D630[1 * 1 * 6 * 1];
extern const pixel_t bitmap_D636[7];
extern const pixel_t bitmap_D63D[1 * 1 * 4 * 1];
extern const pixel_t bitmap_D641[1 * 1 * 6 * 1];
