 ...
 * 4-entry extent. The pattern-data blocks these pointers reference are not
 * yet extracted as C data -- see start_tune's Translation notes. */
const u8 tune_select_table[28] = {
  0x02, 0x41, 0xF2, 0x5A, 0xF2, 0x65, 0xF2, /* tune 0: tempo=2, ch1=$F241, ch2=$F25A, ch3=$F265 */
  0x04, 0x01, 0xF6, 0x05, 0xF6, 0x09, 0xF6, /* tune 1: tempo=4, ch1=$F601, ch2=$F605, ch3=$F609 */
  0x02, 0x66, 0xF6, 0x6A, 0xF6, 0x6E, 0xF6, /* tune 2: tempo=2, ch1=$F666, ch2=$F66A, ch3=$F66E */
  0x03, 0xF4, 0xF6, 0xF8, 0xF6, 0xFE, 0xF6  /* tune 3: tempo=3, ch1=$F6F4, ch2=$F6F8, ch3=$F6FE */
};
...
// $F26E (120 rows, byte-exact from bank3.bin)
const u8 title_tune0_ch1_pattern[157] = {
  
};

// $F26B (120 rows, byte-exact from bank3.bin)
const u8 title_tune0_ch2_pattern[160] = {
  
};

// $F350 (120 rows, byte-exact from bank3.bin)
const u8 title_tune0_ch3_pattern[447] = {
  
};

// $F60D (120 rows, byte-exact from bank3.bin)
const u8 title_tune1_ch1_pattern[190] = {
  ...
  0x21, 0x15, 0x21, 0x15, 0x21, 0x15, 0x21, 0x15, 0x21, 0x15
};

// $F62E (120 rows, byte-exact from bank3.bin)
const u8 title_tune1_ch2_pattern[173] = {
  
};

// $F643 (120 rows, byte-exact from bank3.bin)
const u8 title_tune1_ch3_pattern[156] = {
  
};
