...
/* $CCB7-$D271: 5 scene tables (9x5-byte object records + script bytecode). */
const u8 title_scene_data[1467] = {
  0x46, 0x8F, 0x00, 0xEE, 0xCC, 0x5E, 0x8F, 0x04, 0xEC, 0xCC, 0x76, 0x8F, 0x08, 0xF3, 0xCC, 0x8E,
  0x8F, 0x0C, 0xEA, 0xCC, 0xA6, 0x8F, 0x10, 0xE8, 0xCC, 0xC2, 0x8F, 0x04, 0xE6, 0xCC, 0x7C, 0x7D,
  0x18, 0x18, 0xCD, 0xF0, 0x7B, 0x18, 0x49, 0xCD, 0xEA, 0x8F, 0x14, 0xE4, 0xCC, 0xCF, 0x05, 0xCF,
  0x05, 0xCF, 0x05, 0xCF, 0x0A, 0xCF, 0x05, 0xC9, 0xFE, 0xFC, 0x17, 0xD1, 0xCF, 0x0A, 0xC9, 0xFE,
  ...
  0x00, 0xD2, 0xCF, 0x83, 0xD0, 0xAE, 0x1F, 0xD1, 0x3A, 0x7B, 0x27, 0x7C, 0xCD, 0x3A, 0x7B, 0x33,
  0xA4, 0xCD, 0x3A, 0x7B, 0x3F, 0xD1, 0xCD, 0x3A, 0x7B, 0x4B, 0xFE, 0xCD, 0x3A, 0x7B, 0x57, 0x2B,
  0xCE, 0x3A, 0x7B, 0x33, 0x5C, 0xCE, 0x3A, 0x75, 0x6F, 0x89, 0xCE, 0x3A, 0x75, 0x6F, 0xE3, 0xCE,
  0x3A, 0x7B, 0x63, 0xB6, 0xCE, 0xC9, 0x04, 0xFC, 0x14, 0xCF, 0x14, 0xC9, 0xFD, 0x03, 0x11, 0xC9,
  ...
  0x03, 0xC9, 0x01, 0xFB, 0x02, 0xC9, 0x01, 0xFC, 0x01, 0xE2, 0x34, 0x00, 0x3D, 0xCF, 0x3A, 0x8F,
  0x04, 0x4C, 0xCF, 0x3A, 0x8F, 0x08, 0x5C, 0xCF, 0x3A, 0x8F, 0x0C, 0x6C, 0xCF, 0x3A, 0x8F, 0x10,
  0x7C, 0xCF, 0x3A, 0x8F, 0x04, 0x8C, 0xCF, 0x3A, 0x89, 0x18, 0x9C, 0xCF, 0x3A, 0x89, 0x18, 0xBD,
  0xCF, 0x3A, 0x8F, 0x14, 0xAC, 0xCF, 0xCC, 0x21, 0x22, 0x00, 0xCF, 0x1C, 0xCC, 0x0A, 0x0B, 0x00,
  0xCD, 0x00, 0x0B, 0x00, 0xD1, 0xCF, 0x04, 0xD0, 0xDC, 0x34, 0xCC, 0x20, 0x21, 0x00, 0xCF, 0x2F,
  ...
  0x1A, 0xCE, 0x18, 0x14, 0x00, 0xD2, 0x5A, 0x76, 0x27, 0xFA, 0xCF, 0x62, 0x76, 0x33, 0x24, 0xD0,
  0x6A, 0x76, 0x3F, 0x4D, 0xD0, 0x72, 0x76, 0x4B, 0x76, 0xD0, 0x7A, 0x76, 0x57, 0x9F, 0xD0, 0x86,
  0x76, 0x33, 0xC8, 0xD0, 0x90, 0x70, 0x6F, 0xF1, 0xD0, 0x9E, 0x70, 0x6F, 0x43, 0xD1, 0x94, 0x76,
  0x63, 0x1A, 0xD1, 0xC9, 0x00, 0xFC, 0x11, 0xC9, 0x00, 0xFD, 0x06, 0xC9, 0xFE, 0xFE, 0x04, 0xC8,
  ...
  0x2A, 0xC9, 0x06, 0x03, 0x03, 0x18, 0x8F, 0x00, 0x99, 0xD1, 0x30, 0x8F, 0x04, 0x41, 0xD2, 0x48,
  0x8F, 0x08, 0xAE, 0xD1, 0x60, 0x8F, 0x0C, 0x99, 0xD1, 0x78, 0x8F, 0x10, 0x99, 0xD1, 0x94, 0x8F,
  0x04, 0x99, 0xD1, 0x56, 0x7B, 0x18, 0xFF, 0xD1, 0x56, 0x7A, 0x18, 0x20, 0xD2, 0xBA, 0x8F, 0x14,
  0x99, 0xD1, 0xC9, 0x00, 0xFA, 0x0F, 0xCB, 0x0F, 0x10, 0x00, 0xCA, 0x00, 0x10, 0x00, 0xCB, 0x0A,
...
const title_glyph_t title_glyph_table[115] = {
  { 0x0E, 0x04, &title_glyph_bitmaps[0x0000] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x0070] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x00E0] },
  { 0x0E, 0x05, &title_glyph_bitmaps[0x0150] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x01DC] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x024C] },
  { 0x0E, 0x05, &title_glyph_bitmaps[0x02BC] },
  { 0x0E, 0x05, &title_glyph_bitmaps[0x0348] },
  { 0x0E, 0x03, &title_glyph_bitmaps[0x03D4] },
  { 0x0E, 0x03, &title_glyph_bitmaps[0x0428] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x047C] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x04EC] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x055C] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x05CC] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x063C] },
  { 0x0E, 0x05, &title_glyph_bitmaps[0x06AC] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x0738] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x07A8] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x0818] },
  { 0x0E, 0x04, &title_glyph_bitmaps[0x0888] },
  { 0x10, 0x04, &title_glyph_bitmaps[0x08F8] },
  { 0x10, 0x04, &title_glyph_bitmaps[0x0978] },
  { 0x10, 0x04, &title_glyph_bitmaps[0x09F8] },
  { 0x10, 0x05, &title_glyph_bitmaps[0x0A78] },
  { 0x04, 0x06, &title_glyph_bitmaps[0x0B18] },
  { 0x04, 0x06, &title_glyph_bitmaps[0x0B28] },
  { 0x04, 0x06, &title_glyph_bitmaps[0x0B38] },
  { 0x04, 0x06, &title_glyph_bitmaps[0x0B48] },
  { 0x0D, 0x03, &title_glyph_bitmaps[0x0B58] },
  { 0x0A, 0x04, &title_glyph_bitmaps[0x0BA6] },
  { 0x09, 0x04, &title_glyph_bitmaps[0x0BF6] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x0C3E] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x0C7A] },
  { 0x0A, 0x04, &title_glyph_bitmaps[0x0CB6] },
  { 0x0A, 0x04, &title_glyph_bitmaps[0x0D06] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x0D56] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x0D72] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x0D8E] },
  { 0x07, 0x03, &title_glyph_bitmaps[0x0DAA] },
  { 0x04, 0x01, &title_glyph_bitmaps[0x0DD4] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x0DDC] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x0DEC] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x0DFC] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x0E0C] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x0E48] },
  { 0x0A, 0x04, &title_glyph_bitmaps[0x0E84] },
  { 0x0A, 0x04, &title_glyph_bitmaps[0x0ED4] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x0F24] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x0F40] },
  { 0x07, 0x03, &title_glyph_bitmaps[0x0F5C] },
  { 0x07, 0x03, &title_glyph_bitmaps[0x0F86] },
  { 0x04, 0x01, &title_glyph_bitmaps[0x0FB0] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x0FB8] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x0FC8] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x0FD8] },
  { 0x0A, 0x02, &title_glyph_bitmaps[0x0FE8] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x1010] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x104C] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x1088] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x10C4] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x10E0] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x10FC] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x1118] },
  { 0x04, 0x01, &title_glyph_bitmaps[0x1134] },
  { 0x04, 0x01, &title_glyph_bitmaps[0x113C] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x1144] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x1154] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x1164] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x11A0] },
  { 0x0A, 0x04, &title_glyph_bitmaps[0x11DC] },
  { 0x0A, 0x04, &title_glyph_bitmaps[0x122C] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x127C] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x1298] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x12B4] },
  { 0x07, 0x03, &title_glyph_bitmaps[0x12D0] },
  { 0x04, 0x01, &title_glyph_bitmaps[0x12FA] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x1302] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x1312] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x1322] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x1332] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x136E] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x13AA] },
  { 0x0A, 0x03, &title_glyph_bitmaps[0x13E6] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x1422] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x143E] },
  { 0x07, 0x02, &title_glyph_bitmaps[0x145A] },
  { 0x07, 0x03, &title_glyph_bitmaps[0x1476] },
  { 0x04, 0x01, &title_glyph_bitmaps[0x14A0] },
  { 0x04, 0x01, &title_glyph_bitmaps[0x14A8] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x14B0] },
  { 0x04, 0x02, &title_glyph_bitmaps[0x14C0] },
  { 0x0C, 0x03, &title_glyph_bitmaps[0x14D0] },
  { 0x0C, 0x03, &title_glyph_bitmaps[0x1518] },
  { 0x0C, 0x03, &title_glyph_bitmaps[0x1560] },
  { 0x0C, 0x04, &title_glyph_bitmaps[0x15A8] },
  { 0x08, 0x02, &title_glyph_bitmaps[0x1608] },
  { 0x08, 0x02, &title_glyph_bitmaps[0x1628] },
  { 0x08, 0x03, &title_glyph_bitmaps[0x1648] },
  { 0x08, 0x03, &title_glyph_bitmaps[0x1678] },
  { 0x05, 0x01, &title_glyph_bitmaps[0x16A8] },
  { 0x05, 0x02, &title_glyph_bitmaps[0x16B2] },
  { 0x05, 0x02, &title_glyph_bitmaps[0x16C6] },
  { 0x05, 0x02, &title_glyph_bitmaps[0x16DA] },
  { 0x03, 0x07, &title_glyph_bitmaps[0x16EE] },
  { 0x03, 0x06, &title_glyph_bitmaps[0x16F4] },
  { 0x03, 0x06, &title_glyph_bitmaps[0x1700] },
  { 0x03, 0x06, &title_glyph_bitmaps[0x170C] },
  { 0x02, 0x07, &title_glyph_bitmaps[0x1718] },
  { 0x02, 0x07, &title_glyph_bitmaps[0x171C] },
  { 0x02, 0x06, &title_glyph_bitmaps[0x1720] },
  { 0x02, 0x06, &title_glyph_bitmaps[0x1728] },
  { 0x01, 0x07, &title_glyph_bitmaps[0x1730] },
  { 0x01, 0x07, &title_glyph_bitmaps[0x1732] },
  { 0x01, 0x06, &title_glyph_bitmaps[0x1734] },
  { 0x01, 0x06, &title_glyph_bitmaps[0x1738] },
};
