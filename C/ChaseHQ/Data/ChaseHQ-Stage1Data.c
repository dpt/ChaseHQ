...
// clang-format off
  attribute_BRIGHT_BLACK_OVER_WHITE, attribute_BRIGHT_BLACK_OVER_YELLOW, MKATTR(0, 0, ATTR_YELLOW, ATTR_BLACK), MKATTR(0, 0, ATTR_YELLOW, ATTR_BLACK),
  attribute_BRIGHT_BLACK_OVER_WHITE, attribute_BRIGHT_BLACK_OVER_YELLOW, attribute_BRIGHT_BLACK_OVER_YELLOW, MKATTR(0, 0, ATTR_YELLOW, ATTR_BLACK),
  attribute_BRIGHT_BLACK_OVER_WHITE, attribute_BRIGHT_BLACK_OVER_YELLOW, attribute_BRIGHT_BLACK_OVER_YELLOW, MKATTR(0, 0, ATTR_YELLOW, ATTR_BLACK),
  attribute_BRIGHT_BLACK_OVER_WHITE, attribute_BRIGHT_BLACK_OVER_YELLOW, MKATTR(0, 0, ATTR_YELLOW, ATTR_BLACK), MKATTR(0, 0, ATTR_YELLOW, ATTR_BLACK),
  attribute_BRIGHT_BLACK_OVER_YELLOW, attribute_BRIGHT_BLACK_OVER_YELLOW, MKATTR(0, 0, ATTR_YELLOW, ATTR_BLACK), attribute_BLACK_OVER_CYAN
// clang-format on
};
