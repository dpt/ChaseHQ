...
static const u8 stage1_arrest_messages[83] = {
  ...
  TWOBYTES(0xF802),
  TWOBYTES(0x5922),
  'O', 'K', '!', ' ', 'Y', 'O', 'U', ' ', 'A', 'R', 'E', ' ', 'U', 'N', 'D', 'E', 'R', ' ', 'A', 'R', 'R', 'E', 'S', 'T', ' ', 'O', 'N' | STREND,
  6,
  2,
  0,
  TWOBYTES(0xF023),
  TWOBYTES(0x5943),
  'S', 'U', 'S', 'P', 'I', 'C', 'I', 'O', 'N', ' ', 'O', 'F', ' ', 'F', 'I', 'R', 'S', 'T', ' ', 'D', 'E', 'G', 'R', 'E', 'E', ' ' | STREND,
  0x2d,
  2,
  0,
  TWOBYTES(0xF82C),
...
// 0x5F0F
static const u8 map_start_lanes[14] = {
  MAP_LANES(30, MAP_LANES_3L),
  MAP_LANES(2, MAP_LANES_3TO4L),
  MAP_LANES(254, MAP_LANES_4),
  MAP_LANES(34, MAP_LANES_4),
...
// 0x5F2A
static const u8 map_start_leftobjs[78] = {
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(5, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(7, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TREE),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TREE),
  MAP_OBJECTS(5, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TREE),
  ...
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TREE),
  MAP_OBJECTS(11, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TREE),
  MAP_OBJECTS(7, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  ...
  MAP_OBJECTS(1, MAP_OBJ_S1_BUSH),
  MAP_OBJECTS(5, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_STREET_LAMP),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_STREET_LAMP),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_STREET_LAMP),
...
static const u8 map_start_rightobjs[90] = {
  ...
  MAP_OBJECTS(1, MAP_OBJ_S1_STREET_LAMP),
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_CMD_SPLIT(0x6052, 0x6143) // map_left_rightobjs, map_right_rightobjs
};

/* ----------------------------------------------------------------------- */

// $5FD2
static const u8 map_left_curvature[20] = {
  MAP_CURVE_STRAIGHT(15),
  MAP_CURVE_STRAIGHT(15),
  MAP_CURVE_STRAIGHT(15),
...
static const u8 map_left_leftobjs[] = {
  ...
  MAP_OBJECTS(1, MAP_OBJ_S1_TREE),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TELEGRAPH_POLE),
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TELEGRAPH_POLE),
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TELEGRAPH_POLE),
  ...
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TELEGRAPH_POLE),
  MAP_OBJECTS(15, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_STREET_LAMP),
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_STREET_LAMP),
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  ...
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_STREET_LAMP),
  MAP_OBJECTS(2, MAP_OBJ_S1_NONE),
  MAP_CMD_GOTO(0x61BE) // map_tunnel_leftobjs
};
...
static const u8 map_left_rightobjs[] = {
  ...
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TELEGRAPH_POLE),
  MAP_OBJECTS(10, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TELEGRAPH_POLE),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_TELEGRAPH_POLE),
  MAP_OBJECTS(3, MAP_OBJ_S1_NONE),
  ...
  MAP_OBJECTS(1, MAP_OBJ_S1_NONE),
  MAP_OBJECTS(1, MAP_OBJ_S1_STREET_LAMP),
  MAP_CMD_GOTO(0x61C9) // map_tunnel_rightobjs
};
