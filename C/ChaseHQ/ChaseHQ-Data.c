...
const u8 horizon_table[32] = {
  0xFF, 0x7F, 0x55, 0x3F, 0x33, 0x2A, 0x24, 0x1F,
  0x04, 0x01, 0x03, 0x01, 0x02, 0x01, 0x01, 0x01,
...
const u8 debris_subtable_1[19] = {
 0x00,
 0x32,0x10,0x28,0x20,0x23,0x30,0x1E,0x40,0x23,0x50,0x28,0x60,0x32,0x68,0x46,0x70,0x5A,0x78
};

const u8 debris_subtable_2[19] = {
 0x01,
 0x1E,0x48,0x14,0x50,0x0A,0x58,0x0A,0x60,0x14,0x68,0x1E,0x70,0x2D,0x70,0x41,0x78,0x5A,0x78
};

const u8 debris_subtable_3[19] = {
 0x03,
 0x0A,0x80,0x05,0x80,0x05,0x80,0x0A,0x80,0x0F,0x80,0x19,0x80,0x28,0x80,0x3C,0x80,0x5A,0x80
};

const u8 debris_subtable_4[19] = {
 0x01,
 0x1E,0xB0,0x14,0xA8,0x0A,0xA0,0x0A,0x98,0x14,0x90,0x1E,0x88,0x2D,0x88,0x41,0x80,0x5A,0x80
};

const u8 debris_subtable_5[19] = {
 0x02,
 0x32,0xF0,0x28,0xE8,0x23,0xE0,0x1E,0xD0,0x23,0xC0,0x28,0xB0,0x32,0xA0,0x46,0x90,0x5A,0x80
};
